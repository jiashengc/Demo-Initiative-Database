$(document).ready(function() {
  ...
  function getModal(itemid) {
    $.getJSON(url, function(data) {
      ...
      $('#modal-body-1').append('<h4>Cohorts:</h4><span class="modal-filter" id="modal-category-' + icohorts + '">' + icohorts + '</span><h4>Main Category:</h4><span class="modal-filter" id="modal-category-' + icategory + '">' + icategory + '</span><h4>Related Categories:</h4>' + isubcategory + '<h4>Fellow(s):</h4>' + ifellow + '<h4>Status:</h4><span class="modal-filter" id="modal-status-' + istatus + '">' + istatus + '</span><br><br><h4>School and State:</h4>' + ischool + ', ' + istate + '<h4>Region:</h4><span class="modal-filter" id="modal-region-' + iregion + '">' + iregion + '</span><h4>Stakeholders:</h4>' + istakeholders + '<h4>Resources:</h4>' + iresources);
      $('#modal-body-2').append('<h4>Description:</h4>' + idescription + '<h4>Activity:</h4>' + iactivity + '<h4>Desired Outcome:</h4>' + idesiredoutcome + '<h4>Impact Achieved:</h4>' + iimpactachieved + '<h4>Challenges faced and Plans to overcome:');
