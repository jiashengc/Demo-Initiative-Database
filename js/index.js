$(document).ready(function() {
  ...
  function appendData(ititle, icategory, idescription, iwebsite, iimage, iregion, ifellow) {
    $('.list').append('<li><a href="' + iwebsite + '"><img src="' + iimage + '" class="thumb" /></a><span class="name"><a href="' + iwebsite + '">' + ititle + '</a></span><span class="fellow"><br> ' + 'by ' + ifellow + '</span><h5 class="category">Categories: ' + icategory + '<br><br><p class="description">' + idescription + '</p></li>');
  }
